...
</div>  <main> <div class="container py-4 video-page"> <div class="gameprofile_background" style="background-image: url(g/325/background.webp);"> <div class="gameprofile_gradient"></div> </div> <div class="row">  <div class="col-md-4"> <div class="sidebar control-box"> <div class="card shadow mb-3 rounded"> <img class="img2 card-img-top progressive replace" width="331" height="201" src="g/325/thumbnail.jpg" alt="MapleStory"> <video class="featuredvideo" loop preload="none" muted><source src="g/325/videoplayback.webm" type="video/webm"></source></video> </div> <div class="row"> <div class="col-3 col-lg-2 mr-2"> <span class="btn btn-dark2 mb-3">FREE</span> </div> <div class="col"> <a type="button" name="playnow" class="btn btn-ftg-blue btn-block" href="http://maplestory.nexon.net/" rel="nofollow" target="_blank"><strong>PLAY NOW </strong><i class="fas fa-sign-out-alt"></i></a> </div> </div>  <div class="rate-section btn-group btn-block mb-3 text-center shadow-sm rounded"> <!-- Reaction Buttons -->
...
<input type="hidden" id="gameId" value="255"> <!-- Replace 1 with the actual game ID -->
...
</script>  <h2 class="mt-4 h3">About MapleStory</h2> <hr class="mt-2 mb-3"> <div id="summary"> <p class="collapse text-justify" id="collapseSummary"> MapleStory is a popular free-to-play 2D MMORPG with cartoony graphics that was released in 2003 (in South Korea). Unlike most MMORPGs, MapleStory is a 2D side-scroller, however is very polished with hundreds of hours of gameplay and focus on combat and dungeon exploration. Players create characters by choosing between one of 32 playable classes: From Magicians and warriors to time travelers, there’s a class for every playstyle!<br> <br> As with most free-to-play MMOs MapleStory features a cash shop where players can use real-world money to purchase avatars, pets, boosts and other in-game items. Most of these items have an expiration period, ensuring players will need to purchase more as they continue to play. It’s important to note that the game varies slightly depending on region, with some having less class options and slightly differing quests. The cash shop varies slightly as well. </p> <a class="collapsed" data-toggle="collapse" href="#collapseSummary" aria-expanded="false" aria-controls="collapseSummary"></a> </div> <hr> <div class="text-muted disclosure"> <p>Disclosure: FreeToGame works closely with publishers and developers to offer a free and rewarding experience. In order to keep everything free to use we may sometimes earn a small commission from some partners. Find more info in our <a href="faq.php">FAQ</a> page. </p> <p> </p> </div>  <h2 class="mt-5 h3">Additional Information</h2> <div class="text-muted mt-n2"> <i class="fas fa-info-circle mr-2"></i>Please note this free-to-play game may or may not offer optional in-game purchases.</div> <hr class="mt-2 mb-3"> <div class="row mb-3"> <div class="col-6 col-md-4"> <span class="text-muted">Title<br></span> <p>MapleStory</p> </div> <div class="col-6 col-md-4"> <span class="text-muted">Developer<br></span> Wizet </div> <div class="col-6 col-md-4"> <span class="text-muted">Publisher<br></span> Nexon </div> <div class="col-6 col-md-4"> <span class="text-muted">Release Date<br></span> May 11, 2005 </div> <div class="col-6 col-md-4"> <span class="text-muted">Genre<br></span> MMORPG </div> <div class="col-6 col-md-4"> <span class="text-muted">Platform<br></span> <i class="fab fa-windows mr-1"></i> Windows (Client) </div> </div>  <h2 class="h3 font-weight-dark text-center text-lg-left mt-5 mb-0">MapleStory Screenshots</h2> <hr class="mt-2 mb-3"> <div class="row text-center text-lg-left"> <div class="col-lg-4 col-md-4 col-6"> <a href="g/325/MapleStory-1.jpg" data-lity class="d-block mb-3 h-100" alt="MapleStory Gameplay Screenshot 1"> <img class="thumb-gallery shadow-sm rounded" src="g/325/MapleStory-1-small.jpg" alt="MapleStory Thumbnail 1"> </a> </div> <div class="col-lg-4 col-md-4 col-6"> <a href="g/325/MapleStory-2.jpg" data-lity class="d-block mb-3 h-100" alt="MapleStory Gameplay Screenshot 2"> <img class="thumb-gallery shadow-sm rounded" src="g/325/MapleStory-2-small.jpg" alt="MapleStory Thumbnail 2"> </a> </div> <div class="col-lg-4 col-md-4 col-6"> <a href="g/325/MapleStory-3.jpg" data-lity class="d-block mb-3 h-100" alt="MapleStory Gameplay Screenshot 3"> <img class="thumb-gallery shadow-sm rounded" src="g/325/MapleStory-3-small.jpg" alt="MapleStory Thumbnail 3"> </a> </div> </div>  <h2 class="h3 font-weight-dark text-center text-lg-left mt-5 mb-0">Minimum System Requirements <span class="small text-muted">(Windows)</span> </h2> <hr class="mt-2 mb-3"> <div class="row"> <div class="col-sm-6"> <span class="text-muted">OS<br></span> <p>XP / Vista / 7 / 8</p> <span class="text-muted">Memory<br></span> <p>2 GB</p> <span class="text-muted">Storage<br></span> <p>8 GB</p> </div> <div class="col-sm-6"> <span class="text-muted">Processor<br></span> <p> Intel Pentium 4 or AMD Equivalent</p> <span class="text-muted">Graphics<br></span> <p>Any 128 MB Graphics Card</p> <span class="text-muted">Additional Notes<br></span> <p>Specifications may change during development</p> </div> </div>  <hr> <div class="text-muted small">All material on this page is copyrighted by ©Nexon and their respective licensors. All other trademarks are the property of their respective owners.</div> <div class="row mt-2 align-items-center mb-5"> <div class="col text-muted justify-content-center">Play this game and post your review! </div> <div class="col-6"> <a class="btn btn-primary float-right" href="#submitReview" role="button">Submit Review</a> </div> </div>  <a href="like/maplestory.php" class="btn btn-outline-secondary btn-sm float-right">See All<i class="ml-1 fas fa-chevron-right"></i></a> <h2 class="h3">Games like MapleStory</h2> <hr class="mt-2 mb-3"> <div class="row text-center text-lg-left"> <div class="game-card col-md-4 col-md-4 mb-4 video-card" data-video-src="/g/322/videoplayback.webm"> <div class="card grow shadow"> <div class="image-wrappers"> <img class="img2 card-img-top" width="262" height="148" src="g/322/thumbnail.jpg" alt="La Tale Evolved - A 2D side-scrolling fantasy MMORPG with anime-inspired graphics."> <div class="loader-wrapper"> <div class="spinner-grow ftg-blue" role="status"> <span class="sr-only">Loading...</span> </div> </div> </div> <video class="featuredvideo3widget" loop preload="none" muted></video> <div class="card-body"> <span class="badge badge-ftg py-1 px-1 mt-1 float-right">FREE</span> <a href="la-tale.php" class="stretched-link no-underline"><h4 class="card-title text-truncate mb-n1">La Tale Evolved</h4></a> </div> </div> </div> <div class="game-card col-md-4 col-md-4 mb-4 video-card" data-video-src="/g/249/videoplayback.webm"> <div class="card grow shadow"> <div class="image-wrappers"> <img class="img2 card-img-top" width="262" height="148" src="g/249/thumbnail.jpg" alt="RPG MO - A nostalgic free MMORPG reminiscent of old-school RPG" s like ultima and runescape.> <div class="loader-wrapper"> <div class="spinner-grow ftg-blue" role="status"> <span class="sr-only">Loading...</span> </div> </div> </div> <video class="featuredvideo3widget" loop preload="none" muted></video> <div class="card-body"> <span class="badge badge-ftg py-1 px-1 mt-1 float-right">FREE</span> <a href="rpg-mo.php" class="stretched-link no-underline"><h4 class="card-title text-truncate mb-n1">RPG MO</h4></a> </div> </div> </div> <div class="game-card col-md-4 col-md-4 mb-4 video-card" data-video-src="/g/308/videoplayback.webm"> <div class="card grow shadow"> <div class="image-wrappers"> <img class="img2 card-img-top" width="262" height="148" src="g/308/thumbnail.jpg" alt="Angels Online - A cute anime MMORPG with a good selection of classes."> <div class="loader-wrapper"> <div class="spinner-grow ftg-blue" role="status"> <span class="sr-only">Loading...</span> </div> </div> </div> <video class="featuredvideo3widget" loop preload="none" muted></video> <div class="card-body"> <span class="badge badge-ftg py-1 px-1 mt-1 float-right">FREE</span> <a href="angels-online.php" class="stretched-link no-underline"><h4 class="card-title text-truncate mb-n1">Angels Online</h4></a> </div> </div> </div> </div> </div> </div> </div> </div> </main> </body> 
<!-- Mirrored from www.freetogame.com/maplestory by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 25 Mar 2024 08:08:35 GMT -->
